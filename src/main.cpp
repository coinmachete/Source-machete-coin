...
uint256 hashGenesisBlock("0xe886d5f8a2d1a87781b3e99cbf84b6ad4dcb49638184504305cce163daa3dd4c");
...
const string strMessageMagic = "MACHETECOIN Signed Message:\n";
...
static const int64 nTargetSpacing = 75; // 75 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal MACHETECOIN miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MACHETECOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Sun, 08 Mar 2015 14:59:18 GMT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x7dbeb1ebdebf66bdbc53bf70f3a67b07216ab98aaeb072ab6a08e8b4651db47e"));
