...
// activated: after block 0 for all following diff retargeting events
#define COINFIX1_BLOCK  (0)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1152 / 250; // Priority cutoff is 1 MTC day / 250 bytes.
    }
